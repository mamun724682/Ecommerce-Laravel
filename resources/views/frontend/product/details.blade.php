    ...
    <div class="row">
      <div class="col-lg-10 col-md-12 col-lg-offset-1">
        <div class="ps-product__thumbnail">
          <div class="ps-product__preview">
            ...
            <a class="popup-youtube ps-product__video" href="http://www.youtube.com/watch?v=0O2aH4XLbto">
              <img src="{{ $product->getFirstMediaUrl('products') }}" alt=""><i class="fa fa-play"></i>
            </a>
          </div>
        ...
        <div class="ps-product__thumbnail--mobile">
          <div class="ps-product__main-img"><img src="{{ $product->getFirstMediaUrl('products') }}" alt=""></div>
        ...
        <div class="ps-product__info">
          ...
          <h3 class="ps-product__price">৳ {{ $product->sale_price ?? $product->price }} <del>{{ $product->sale_price ? '৳'.$product->price : '' }}</del></h3>
          ...
          <div class="ps-product__block ps-product__style">
            ...
            <ul>
              @foreach ($product->getMedia('products') as $images)
              <li><a href="#"><img src="{{ $images->getUrl() }}" alt=""></a></li>
              @endforeach
            </ul>
          </div>
